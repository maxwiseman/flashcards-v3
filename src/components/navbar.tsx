...
export function Navbar(): React.ReactElement {
  ...
  return (
    <nav className="bg-red justify-apart sticky top-0 z-50 flex h-20 w-full items-center gap-4 border-b-[1px] border-border bg-background p-5 px-8">
      <div className="flex h-full w-full flex-row items-center gap-4">
        <Link aria-label="Home" className="h-full" href="/">
          {/* <Image
            alt="Logo"
